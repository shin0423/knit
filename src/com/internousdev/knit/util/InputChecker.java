...
public class InputChecker {
	...
	public String userAddress1Chk(String userAddress) {
		String result = "OK";
	...
	public String sexChk(String sex) {
		String result = "OK";
		 ...
		 if(sex==null){
				result = "性別を入力してください";
		}else if (!(sex.equals("0") || sex.equals("1"))) {
			result = "性別の値が不正です";
		}
		return result;
	}
	...
	public String itemNameChk(String itemName) {
		...
		if (itemName.equals("")) {
			result = "商品名を入力してください。";
		} else if (itemName.length() < 1 || itemName.length() > 25) {
			result = "商品名は1文字以上25文字以下で入力してください。";
		}
		return result;
	}
	...
	public String itemDescriptionChk(String itemDescription) {
		...
		} else if (itemDescription.length() < 1 || itemDescription.length() > 50) {
			result = "商品詳細は1文字以上50文字以下で入力してください。";
		}
		return result;
	}
	...
	public String categoryDescriptionChk(String categoryDescription) {
		...
		} else if (categoryDescription.length() < 1 || categoryDescription.length() > 50) {
			result = "カテゴリー詳細は1文字以上50文字以下で入力してください。";
		}
		return result;
	}
